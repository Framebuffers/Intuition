// Base class. Holds all the variables.
using Godot;
...
namespace Intuition.Camera
{
	public sealed partial class Player : StairsCharacter
	{
		...
		// TODO: Churn out any unneccesary features from the original QualityFirstPersonController
		...
		public override void _PhysicsProcess(double delta)
		{
			...
			// now this shit I ain't touching anytime soon cause it breaks so easily.
		...
		{
			PackedScene b = ResourceLoader.Load<PackedScene>("res://Items/projectile.tscn");
			RigidBody3D r = (RigidBody3D)b.Instantiate();
			AddChild(r);
			r.ShootFrom(this, 10);
		}
		...
		public override void _UnhandledInput(InputEvent @event)
		{
			...
			//
			// @event.OnClickEvent(ShootProjectile);
			...
			switch (@event)
			{
				...
				case InputEventMouseButton:
					...
					// if (b.ButtonIndex == MouseButton.Left) ShootProjectile();
					HandleItemDetection();
					break;
			}
		}
